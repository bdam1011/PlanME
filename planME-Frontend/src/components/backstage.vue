  ...
  <div class="aaa" v-if="type === '1'">
    <div class="header" v-for="item in listatc" :key="item.id">
      <div class="card-header">
        {{ item.atctitle }}
        <p class="card-text">{{ item.atctext }}</p>
        <button class="btn btn-secondary mx-2" @click="saveAtc()" :id="item.atcid">保留</button>
        <button class="btn btn-secondary" @click="delatc()" :id="item.atcid" >刪除</button>
      </div>
    </div>
  </div>
   ...
   <div class="aaa" v-if="type === '2'">
    <div class="header" v-for="item in listmsg" :key="item.id">
      <div class="card-header">
        {{ item.atctitle }}
        <p class="card-text">{{ item.mstext  }}</p>
        <button class="btn btn-secondary mx-2"  @click="saveMsg()" :id="item.msgid">保留</button>
        <button class="btn btn-secondary" @click="delmsg()" :id="item.msgid">刪除</button>
      </div>
    </div>
  </div>
